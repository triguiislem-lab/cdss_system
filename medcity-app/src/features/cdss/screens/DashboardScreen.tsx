...
export default function CdssDashboard({ basePath = "/admin/cdss" }: { basePath?: string }) {
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-border">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              Doctor remains responsible for final validation on every case.
            </p>
          </div>
          <Link href={`${basePath}/prescription/review`} className="text-xs font-semibold text-primary hover:underline inline-flex items-center gap-1">
                ...
                return (
                  <tr key={rx.id} className="hover:bg-muted/40 transition-smooth">
                    ...
                    <td className="px-5 py-3.5 text-right">
                      <Link href={`${basePath}/prescription/review`} className="inline-flex items-center gap-1 rounded-lg border border-input bg-card px-3 py-1.5 text-xs font-semibold hover:bg-muted transition-smooth">
